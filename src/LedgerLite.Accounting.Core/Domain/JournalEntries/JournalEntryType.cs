...
public sealed class JournalEntryType : SmartEnum<JournalEntryType>
{
    ...
    /// </summary>
    public static readonly JournalEntryType Standard = new(name: nameof(Standard), value: 1);

    /// <summary>
    ///     A journal entry that is posted at regular time intervals.
    /// </summary>
    public static readonly JournalEntryType Recurring = new(name: nameof(Recurring), value: 2);

    /// <summary>
    ///     Records end-of-period adjustments to comply with the accrual method of accounting.
    /// </summary>
    public static readonly JournalEntryType Adjusting = new(name: nameof(Adjusting), value: 3);

    /// <summary>
    ///     "Reverses" adjusting journal entries to avoid double-counting.
    /// </summary>
    public static readonly JournalEntryType Reversing = new(name: nameof(Reversing), value: 4);

    /// <summary>
    ///     Contains more than one credit or debit lines.
    /// </summary>
    public static readonly JournalEntryType Compound = new(name: nameof(Compound), value: 5);

    /// <summary>
    ///     Used when opening and setting up new books.
    /// </summary>
    public static readonly JournalEntryType Opening = new(name: nameof(Opening), value: 6);

    /// <summary>
    ///     Transfers temporary account balances (e.g: income, expenses) to a permanent
    ///     equity account.
    /// </summary>
    public static readonly JournalEntryType Closing = new(name: nameof(Closing), value: 7);
