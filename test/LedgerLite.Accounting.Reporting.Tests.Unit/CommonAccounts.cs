...
internal static class CommonAccounts
{
    ...
    // Liabilities
    public static readonly Account AccountsPayable = FakeAccounts.Get(x => x.WithName("Accounts Payable", AccountType.Liability));
    public static readonly Account LoansPayable = FakeAccounts.Get(x => x.WithName("Loans Payable", AccountType.Liability));
    ...
    // Expenses
    public static readonly Account CostOfSales = FakeAccounts.Get(x => x.WithName("Cost of Sales", AccountType.Expense));
    public static readonly Account LaundryCosts = FakeAccounts.Get(x => x.WithName("Laundry Costs", AccountType.Expense));
}